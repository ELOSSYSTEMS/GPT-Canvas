...
Purpose: first-class recovery registry for the reconstructed canvas corpus.
...
- conflicts: 0
  ...
  - `AI.100.OVL.V7` - Allon-Psych-Overlay-v7 [complete]
...
- conflicts: 0
  ...
  - `AO.930.WATCH` - AO.930.WATCH – Autonomous Self-Diagnostics Monitor [complete]
...
- conflicts: 1
  ...
  - `EL.410.TNF.BENCHMARK.SOCIAL` - TNF_Benchmark_Social_Identity [complete]
...
- conflicts: 0
  ...
  - `NAME.AI.203.Embedding` - AI.203.Embedding [complete]
  - `NAME.AI.204.Weights` - AI.204.Weights [complete]
  - `NAME.AI.205.Training` - AI.205.Training [complete]
  - `NAME.AI.206.FineTuning` - AI.206.FineTuning [complete]
  - `NAME.AI.207.Tokenization` - AI.207.Tokenization [complete]
  - `NAME.AI.301.CoT` - AI.301.CoT [complete]
  - `NAME.AI.302.Inference` - AI.302.Inference [complete]
  - `NAME.AI.303.GroundTruth` - AI.303.GroundTruth [complete]
  - `NAME.AI.304.Hallucination` - AI.304.Hallucination [complete]
  - `NAME.AI.305.Explainability` - AI.305.Explainability [complete]
  - `NAME.AI.306.Alignment` - AI.306.Alignment [complete]
  - `NAME.AI.401.Chatbot` - AI.401.Chatbot [complete]
  - `NAME.AI.403.AIAgent` - AI.403.AIAgent [complete]
  - `NAME.AI.404.AIWrapper` - AI.404.AIWrapper [complete]
  - `NAME.AI.501.Supervised` - AI.501.Supervised [complete]
  - `NAME.AI.502.Unsupervised` - AI.502.Unsupervised [complete]
  - `NAME.AI.503.Reinforcement` - AI.503.Reinforcement [complete]
  - `NAME.AI.504.Dataset` - AI.504.Dataset [complete]
  - `NAME.AI.505.TrainingReuse` - AI.505.TrainingReuse [complete]
  - `NAME.AI.604.EmbeddingReuse` - AI.604.EmbeddingReuse [complete]
  - `NAME.AI.605.Context` - AI.605.Context [complete]
  - `NAME.AI.702.Compute` - AI.702.Compute [complete]
  - `NAME.AI.703.VibeCoding` - AI.703.VibeCoding [complete]
  - `NAME.AI.704.Parameters` - AI.704.Parameters [complete]
  - `NAME.AI.705.WeightsReuse` - AI.705.WeightsReuse [complete]
...
- conflicts: 0
  ...
  - `PR.300.GHO` - The Ghost [complete]
  - `PR.300.ORN` - The Contrarian (Oren) [complete]
...
- conflicts: 0
  ...
  - `VV.999.META` - VV.999.META – vVerse Core Logic Stack [complete]
  - `VV.999.MIN` - VV.999.MIN – vVerse MiniHUD Sidebar Overlay [complete]
  - `VV.999.PTN` - VV.999.PTN – Pattern Memory Engine [complete]
  - `VV.999.SCN` - VV.999.SCN – Scenario Reconstructor [complete]
