...
- `NAME.dabroo_sidebar_layout` latest body is partial
- `NAME.forever_flowers_homepage` latest body is partial
- `NAME.interactive_bouquet_tool` latest body is partial
- `NAME.Israeli-Centric-Use-Cases` latest body is partial
- `NAME.persona_response_formatting` latest body is partial
- `NAME.Podcast-Dave-8_29_18` latest body is partial
- `PR.700.CPC` latest body is partial
...
- message `776f01fb-a6ca-4ffd-89d6-98e6658c9f92` artifact `NAME.forever_flowers_pricing` reason=regex-no-match
- message `5b3b7f4b-6f9b-4cec-9ef7-232ae9bdcb79` artifact `NAME.Allon_Memory_Consolidation` reason=regex-no-match
- message `030178fa-025a-4ab0-b22c-d3ede95cd03b` artifact `NAME.Allon_Memory_Consolidation` reason=regex-no-match
- message `55a54f2b-4758-4247-8f61-c3d1fcc8c211` artifact `DA.300.LOG` reason=regex-no-match
- message `55a54f2b-4758-4247-8f61-c3d1fcc8c211` artifact `DA.300.LOG` reason=regex-no-match
- message `b97cf4b0-76bb-4708-8aa6-eb706dc1d670` artifact `DA.300.LOG` reason=regex-no-match
- message `b97cf4b0-76bb-4708-8aa6-eb706dc1d670` artifact `DA.300.LOG` reason=regex-no-match
- message `c003a7d4-2e09-4287-b294-3101875a102c` artifact `DA.300.LOG` reason=regex-no-match
- message `5b7a4547-b74e-440d-86c6-7d4749312884` artifact `DA.300.LOG` reason=regex-no-match
- message `5029d5dd-2a9d-4e57-a873-11ca1823c38c` artifact `DA.300.LOG` reason=regex-no-match
- message `3e9951a7-b4fb-40e8-bc9b-48d329502c1f` artifact `FF.100.TDL` reason=regex-no-match
- message `3e9951a7-b4fb-40e8-bc9b-48d329502c1f` artifact `FF.100.TDL` reason=regex-no-match
- message `e2f7202b-a50b-4302-af9b-3ff62aeca7b0` artifact `FF.100.TDL` reason=regex-no-match
- message `e2f7202b-a50b-4302-af9b-3ff62aeca7b0` artifact `FF.100.TDL` reason=regex-no-match
- message `4b5e391b-45e4-4639-b368-2f9e6758b260` artifact `IN.100.ALL` reason=regex-no-match
...
- message `7d5ced82-7197-4a2b-9a51-1c7121ab315e` artifact `NAME.Redundancy-Audit-60-Pair-Merge-Log` reason=regex-no-match
- message `c0c3705d-a773-44c0-bb1c-c6d5705b63a8` artifact `NAME.Redundancy-Audit-60-Pair-Merge-Log` reason=regex-no-match
- message `c0c3705d-a773-44c0-bb1c-c6d5705b63a8` artifact `NAME.Redundancy-Audit-60-Pair-Merge-Log` reason=regex-no-match
- message `c9344903-f3ba-4bdb-85b1-e3844f934f8f` artifact `ELOS.100.STF` reason=regex-no-match
...
- message `3dcb3e3c-114f-464d-b228-a08b5443f3de` artifact `NAME.autopromptwriter_contentjs` reason=missing-replacement
...
- message `dbdc808e-3760-43d8-9780-4587d0dae06a` artifact `NAME.Stargate_Hybrid_Protocol_Config` reason=regex-no-match
- message `dbdc808e-3760-43d8-9780-4587d0dae06a` artifact `NAME.Stargate_Hybrid_Protocol_Config` reason=regex-no-match
- message `d45d23d6-4450-425e-a28a-055447cf137d` artifact `AO.001.RBI` reason=regex-no-match
- message `0cf9c063-e372-42a7-8c5a-bc55ebbfe363` artifact `AO.910.PRM` reason=no-current-body-for-partial-update
- message `732bc8a9-42cb-48d6-853b-c3d8e2834a93` artifact `AO.911.IDE` reason=regex-no-match
- message `6ec6bcaa-258f-47a7-a443-0eeb3934840c` artifact `AO.911.IDE` reason=regex-no-match
- message `d9feef6b-f82e-4211-b816-f7d3aed3c287` artifact `AO.911.IDE` reason=regex-no-match
- message `830583dd-f197-4376-ac06-93ff3e19a16b` artifact `AO.911.IDE` reason=regex-no-match
- message `c0b103c3-0aaf-46f7-9048-ce2398d141bf` artifact `AO.911.IDE` reason=regex-no-match
...
- message `c2d35ad9-73e8-4afa-968e-639f82373267` artifact `PR.210.DBT` reason=no-current-body-for-partial-update
- message `98d4b59f-f1c3-4c46-8503-e29351236338` artifact `PR.210.DBT` reason=no-current-body-for-partial-update
- message `aefb422f-bd63-4f1a-88a1-f879439af17c` artifact `PR.210.DBT` reason=no-current-body-for-partial-update
...
- message `2051efdb-c33a-4679-8aa7-c85306e9ed06` artifact `PR.000.SPP` reason=no-current-body-for-partial-update
- message `498d906e-700e-475c-8026-56cd941da5e0` artifact `PR.000.SPP` reason=no-current-body-for-partial-update
- message `b195026f-d5bb-45e8-b014-7942d68c2547` artifact `PR.000.SPP` reason=no-current-body-for-partial-update
- message `3a0acbb0-b7ef-41e1-99bc-f219c71c1741` artifact `AI.850.MOS` reason=regex-no-match
- message `ea11bbf9-d34f-4197-b939-b21824a73cdc` artifact `NAME.FOREVER_FLOWERS_PERSONALIZED_FLOW_SUMMARY.md` reason=regex-no-match
- message `afb27002-fe69-478f-a76f-2fabab7c9c42` artifact `NAME.FOREVER_FLOWERS_PERSONALIZED_FLOW_DIAGRAM.md` reason=regex-no-match