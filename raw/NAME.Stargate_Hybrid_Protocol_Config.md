  ...
  "elos_protocol": {
    ...
    "execution_mode": {
      ...
      "behavior": {
        ...
        "trace": {
          "output": ["phase_status", "before_after", "role_echo"]
        },
        "audit": {
          "output": ["phase_status", "before_after", "diagnostics", "fallbacks_injected"]
        },
        "phase": {
          "output": [
            "Phase 1 ✅",
    ...
    "output_modes": {
      "stealth": true,
      "trace": "activated by !trace",
      "audit": "activated by !audit",
      "phase": "activated by !phase"
    }
  }
}