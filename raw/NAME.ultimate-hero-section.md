{% schema %}
{
  ...
  "settings": [
    ...
    { "type": "checkbox", "id": "show_main_image_always", "label": "Always show Main Image (even in banner mode)", "default": false },
...
<section class="ultimate-hero">
  ...
  <div class="container">
    ...
    {% if section.settings.main_image and (section.settings.layout == 'split' or section.settings.show_main_image_always == true) %}
