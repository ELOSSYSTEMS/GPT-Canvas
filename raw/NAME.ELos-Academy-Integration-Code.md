...
### ✅ 8. ELos Academy UI Entry (Checklist Only)
- [ ] Academy link or label appears in sidebar
- [ ] Academy entry visible in all tiers
- [ ] Clicking academy shows onboarding placeholder or modal
- [ ] Consistent design and position across navigations
- [ ] No visual overlap or injection conflicts
