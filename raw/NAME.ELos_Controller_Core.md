{
  "protocol_version": "3.1-total-fireproofed",
  "structure": {
  ...
  "fireproofing": {
    ...
    "system_guards": {
      ...
      "blocked_phrases": ["in today’s world", "it is important to note", "etc", "things like", "whatever works"],
      "empty_structure_response": "Prompt missing essential structure. Please include a task or topic.",
      "short_prompt_rewrite": "This prompt is too short. Please rewrite with a full task description."
    }
  },
  "synthesis_firewall": {
    "confidence_threshold": 0.7,
    "manual_override_priority": true,
    "block_for_factual_prompts": true,
    "post_injection_audit": true
  },
  "post_processing": {
  ...
  "modes": {
    "stealth": { "visible_output": false, "default": true },
    "audit": { "visible_output": true, "phase_markers": false },
    "phase": { "visible_output": true, "phase_markers": ["Phase 1 ✅", "Phase 2 ✅", "Phase 3 ✅"] }
  },
  "glyph_triggers": [
    { "glyph": "!synth", "function": "lock tone and constraints strictly" },
    { "glyph": "!learn", "function": "enable verbose educational output" }
  ],
  "excluded_features": ["prompt_history_cycling", "favorites_UI", "live_ghost_prompt_preview"]
}