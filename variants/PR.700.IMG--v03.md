...
const ForeverFlowersPhotoRoomPromptEngine = {
  ...
  /**
   * Build prompt for any specific bouquet and vase combo
   */
  generate({
...
const prompt = ForeverFlowersPhotoRoomPromptEngine.generate({
  bouquetDescription: "elegant preserved arrangement featuring hydrangea, pink chrysanthemums, and golden eucalyptus",
  vaseDescription: "sculptural ivory vase with soft curves",
  tableSurface: "light oak table",
  environment: "airy Tel Aviv apartment with neutral decor and natural sunlight",
  surroundingProps: "magazine, coffee cup, sheer curtain shadow"
});
