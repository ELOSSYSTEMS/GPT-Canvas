...
// Description: Forked from EL.420.HBR and now embedded inside Stargate Kernel via dynamic routing logic. Bootloader-aware.
...
(function() {
  ...
  // Bootloader-Aware Init
  function initialize() {
    inputObserver.observe(document.body, { childList: true, subtree: true });
    attachOutputInterceptor();
    console.log('[ELOS Bootloader] Translate 2.1-EXT Hebrew Protocol Mounted');
  }
