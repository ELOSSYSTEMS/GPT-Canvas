...
const fetchInsights = async () => {
  ...
  return agent ? agent.getAdvancedData() : { updates: [], ratings: [], history: [] };
};

export default function ELosInsightsDashboard() {
  const [data, setData] = useState({ updates: [], ratings: [], history: [] });
    ...
    <div className="p-6">
      ...
      <Tabs defaultValue="updates">
        <TabsList className="mb-4">
          ...
          <TabsTrigger value="history">🧠 Prompt Usage History</TabsTrigger>
        </TabsList>
