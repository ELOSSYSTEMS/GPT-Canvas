  ...
  WRITE_POST: [
    ...
    { role: 'system', text: '🌸 נושא: {{post_topic}}\n\n[כאן יבוא הפוסט השיווקי].' },
    {
      ...
      options: [
        ...
        { label: 'ללמוד איך לנסח פרומפט', trigger: 'LEARN_PROMPT' },
        { label: 'לקבל ערכת התחלה חינמית', trigger: 'STARTER_PACK_CTA' }
      ]
    }
  ],
  LEARN_PROMPT: [
  ...
  WHAT_IS_PROMPT: [
    ...
    { role: 'system', text: 'הנה איך GPT יגיב לזה:\n[תגובה של GPT לפרומפט שלך כאן]' },
    {
      ...
      options: [
        { label: 'לכתוב פוסט', trigger: 'WRITE_POST' },
        { label: 'לקבל ערכת התחלה חינמית', trigger: 'STARTER_PACK_CTA' },
        { label: 'לחזור לתחילת המסע', trigger: 'ABOUT' }
      ]
    }
  ],
  STARTER_PACK_CTA: [
    { role: 'system', text: '✨ יש לנו ערכת התחלה חינמית + אפשרות לתמיכה אישית.' },
    {
      role: 'system',
      text: 'מה מעניין אותך?',
      options: [
        { label: 'רק הערכה החינמית בבקשה 🙏', trigger: 'EMAIL_CAPTURE' },
        { label: 'רוצה לרכוש את המוצר המלא 💸', trigger: 'REDIRECT_PRO' },
        { label: 'אני צריך תמיכה אישית 🧠', trigger: 'CONSULT_REQUEST' }
      ]
    }
  ],
  EMAIL_CAPTURE: [
    { role: 'system', text: 'בשמחה! רק תן לנו את כתובת המייל שלך:' },
    { role: 'input', id: 'email' },
    { role: 'system', text: '📩 תודה! הערכה תישלח אליך בקרוב.' },
    { role: 'system', text: 'רוצה בינתיים לכתוב פוסט או ללמוד עוד?',
      options: [
        { label: 'לכתוב פוסט', trigger: 'WRITE_POST' },
        { label: 'ללמוד על פרומפטים', trigger: 'LEARN_PROMPT' }
      ]
    }
  ],
  REDIRECT_PRO: [
    { role: 'system', text: '🔗 מעולה. מעביר אותך לעמוד הרכישה...', trigger: 'EXTERNAL_REDIRECT' }
  ],
  CONSULT_REQUEST: [
    { role: 'system', text: 'נשמע טוב. רק תן לנו את מספר הטלפון או המייל שלך וניצור קשר בהקדם.' },
    { role: 'input', id: 'phone_or_email' },
    { role: 'system', text: '✅ תודה. ניצור קשר לתיאום אישי.' }
  ]
};