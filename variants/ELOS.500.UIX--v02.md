...
- **Color Shift:** Logo color adapts by tier:
  - **Beginner:** White tree on black (Seedling phase)
  - **Intermediate:** Blue gradient bloom (Growing phase)
  - **Pro:** Gold bloom (Fully bloomed, radiant aura)
...
- **Logo State:** Tree icon in white (seedling)
...
- **Logo State:** Tree in blue bloom (growth)
...
- **Logo State:** Tree in gold (full bloom)
