      ...
      <div class="page-width text-center">
        <p class="prose heading announcement-bar__message">
          ...
          {% if section.settings.secondary_button_text and section.settings.secondary_button_link %}
            <a class="discount-bar__link-button" href="{{ section.settings.secondary_button_link }}" onclick="document.querySelector('.discount-bar').style.display='none';">
...
{% javascript %}// No JS block required for now. Using inline onclick handler.
{% endjavascript %}
