{
  ...
  "description": "The unified execution and validation system governing prompt processing across ELOS, Allon OS, and experimental extensions. Each layer is activated selectively based on task, language, format, or intent."
}