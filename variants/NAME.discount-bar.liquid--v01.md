...
{% if section.settings.enabled %}
  ...
  <div class="custom-discount-bar" 
       ...
       data-redirect="{{ section.settings.redirect_url | default: '/discount/' | append: section.settings.discount_code | url_escape }}"
...
{% stylesheet %}
.custom-discount-bar {
  background-color: #f5f5f3; /* matches Prestige Scheme 4 neutral */
...
(function() {
  ...
  btn.addEventListener('click', function() {
    ...
    if (bar.dataset.autoredirect === 'true' && bar.dataset.redirect) {
      window.location.href = bar.dataset.redirect;
    }
  });
})();
{% endjavascript %}
...
{% schema %}
{
  ...
  "settings": [
    ...
    },
    {
      ...
      "info": "If left blank, defaults to /discount/{code}",
      "default": ""
    },
    {
      "type": "checkbox",
