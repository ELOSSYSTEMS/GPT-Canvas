...
### ✅ 8. ELos Academy Entry Point
- [ ] Academy entry link or button appears in popup or sidebar
- [ ] Clicking opens beginner-friendly onboarding or tutorial pane
- [ ] Matches tier-based behavior (visible in all tiers, but adaptive)
- [ ] Links to interactive walkthroughs or command usage previews

---

**Next Step After QA:**
Trigger: “Ready to add commands” → Begin phase 2 (command engine buildout with tier logic and usage preview UI).