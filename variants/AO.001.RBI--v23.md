{
  ...
  "notes": "This overlay remaps all user-facing and internal terminology to a Star Trek: TNG-compatible structure. Can be toggled at runtime. All functional mappings retain their Dewey IDs and execution logic; only linguistic surface layer is modified."
}